...
--
-- Host: localhost:3306
-- Generation Time: Feb 27, 2021 at 05:14 PM
...
(11, 'faiba', 8000, 0, 2, 5000),
(12, 'garlic ', 70, 1, 2, 50),
(13, 'bread ', 40, 0, 0, 30),
(14, 'milk', 45, 0, 0, 35),
(15, 'safaricom ', 20, 0, 0, 19),
(16, 'biscuits ', 10, 0, 0, 5);
...
(23, 'mary', 'Adhiambo ', 'Konyango ', '0727767652', 'marykonyango74@gmail ', 2, 315, '0f85d2145742c2d65725d10467beb93780b2c7bc51a709e5b0a0c07cbbb1bbd50ac0f801e9d76b91b03e3b653e6e5970b8936c641fa8c47585ae8ad838808afb', 'Yuq52DDj6qClHcjOFE6+rBwB9vLrs8nj1j3krVSG8rHdSLOPxLekWdQcuImodED87CFTE04/w9cBcoUTQvPXaSFBEYY+nIsxjlF+q/6GmiKqjrR40OzGJofO7xnBL4EMVDduz/GVv2eTGaH7b/vnbLiEbl/9Sxki0/O9eunxCNs=', '2021-02-26');
...
--
ALTER TABLE `branch_activation`
  MODIFY `BranchActivationId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `catalogue_items`
  MODIFY `CatalogueItemId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;
...
--
ALTER TABLE `lots`
  MODIFY `LotId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `session_logs`
  MODIFY `SessionLogId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=674;
...
--
ALTER TABLE `user_access_privileges`
  MODIFY `UserAccessPrivilegeId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `user_roles`
--
ALTER TABLE `user_roles`
  MODIFY `UserRoleId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `user_session_activities`
--
ALTER TABLE `user_session_activities`
  MODIFY `UserSessionActivityId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=632;
