...
--
-- Host: localhost:3306
-- Generation Time: Aug 28, 2020 at 11:49 AM
...
CREATE TABLE `session_activities` (
  ...
  `SessionActivityCode` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 14, '2020-08-27 18:37:47', '2020-08-27 18:37:47');
...
--
ALTER TABLE `session_activities`
  MODIFY `SessionActivityId` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `session_logs`
--
ALTER TABLE `session_logs`
  MODIFY `SessionLogId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `user_session_activities`
  MODIFY `UserSessionActivityId` int NOT NULL AUTO_INCREMENT;
