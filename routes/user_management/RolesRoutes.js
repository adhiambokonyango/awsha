...
const third_party= require('../../services/third_party_transaction/ThirdPartyController.js')
  ...
  next();
   ...
   router.post('/add_roles', urlencodedParser,function(request,response){
        ...
        var	jsonObject_ = {
          ...
          var myPromise = RolesController.insert(jsonObject_);
   ...
   router.post('/get_all_roles',urlencodedParser,function(request,response){
    ...
    var myPromise = RolesController.selectAll();
...
router.post('/get_roles',urlencodedParser,function(request,response){

  var myPromise = third_party.fetchAllRoles();
  ...
  myPromise.then(function(result) {
   ...
   router.post('/get_specific_roles',urlencodedParser,function(request,response){
        ...
        var myPromise = RolesController.get_specific_records(mKey,mValue);
   ...
   router.post('/update_roles',urlencodedParser,function(request,response){
    ...
    var myPromise = RolesController.batch_update(jsonObject_);
   ...
   router.post('/update_individual_roles',urlencodedParser,function(request,response){
       ...
       date.setHours(date.getHours()+0);
        ...
        var	jsonObject_ = {
         ...
         var myPromise = RolesController.individual_record_update(column_name,value_,jsonObject_);
   ...
   router.post('/delete_individual_roles',urlencodedParser,function(request,response){
    ...
    var myPromise = RolesController.delete_user_specic_record(column_name,value_,UserIdColumnName,UserId);
   ...
   router.post('/get_number_of_roles_records',urlencodedParser,function(request,response){
    ...
    var myPromise = RolesController.get_number_of_records(column_name,value_);
...
router.post('/roles_user_specific_query',urlencodedParser,function(request,response){
    ...
    var myPromise = RolesController.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
