...
"UserAccessPrivilegesController" class
*/
...
const UserAccessPrivilegesController = require("../../controllers/user_management/UserAccessPrivilegesController.js");
...
router.post("/get_all_user_access_privileges", urlencodedParser, function(
  ...
  var myPromise = UserAccessPrivilegesController.selectAll();
...
router.post(
  ...
  function(request, response) {
    ...
    var myPromise = UserAccessPrivilegesController.delete_user_specic_record(
      column_name,
      value_,
      UserIdColumnName,
      UserId
...
router.post(
  ...
  function(request, response) {
    ...
    var myPromise = UserAccessPrivilegesController.get_number_of_records(
      column_name,
      value_
    );
...
router.post(
  ...
  function(request, response) {
    ...
    var myPromise = UserAccessPrivilegesController.user_specific_select_query(
      ColumnName,
      value_,
      UserIdColumnName,
      UserId
...
router.post("/get_a_user_access_privileges", urlencodedParser, function(
  ...
  var myPromise = UserAccessPrivilegesController.getAUserAccessPrivileges(
    userRoleId
  );
...
router.post("/get_user_access_privileges_for_particular_role", urlencodedParser, function(
  ...
  var myPromise = UserAccessPrivilegesController.getPrivilegesForParticularUserForParticularRole(userId,roleCode,accessPrivilegeCode);
