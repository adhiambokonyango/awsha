...
"SystemAdminRolesController" class
*/
...
const SystemAdminRolesController = require('../../controllers/user_management/SystemAdminRolesController.js');
  ...
  next();
   ...
   router.post('/add_roles', urlencodedParser,function(request,response){
        ...
        var	jsonObject_ = {
          ...
          var myPromise = SystemAdminRolesController.insert(jsonObject_);
   ...
   router.post('/get_all_roles',urlencodedParser,function(request,response){
    ...
    var myPromise = SystemAdminRolesController.get_all_records();
   ...
   router.post('/get_specific_roles',urlencodedParser,function(request,response){
        ...
        var myPromise = SystemAdminRolesController.get_specific_records(mKey,mValue);
   ...
   router.post('/update_roles',urlencodedParser,function(request,response){
    ...
    var myPromise = SystemAdminRolesController.batch_update(jsonObject_);
   ...
   router.post('/update_individual_roles',urlencodedParser,function(request,response){
       ...
       date.setHours(date.getHours()+0);
        ...
        var	jsonObject_ = {
         ...
         var myPromise = SystemAdminRolesController.individual_record_update(column_name,value_,jsonObject_);
   ...
   router.post('/delete_individual_roles',urlencodedParser,function(request,response){
    ...
    var myPromise = SystemAdminRolesController.delete_user_specic_record(column_name,value_,UserIdColumnName,UserId);
   ...
   router.post('/get_number_of_roles_records',urlencodedParser,function(request,response){
    ...
    var myPromise = SystemAdminRolesController.get_number_of_records(column_name,value_);
